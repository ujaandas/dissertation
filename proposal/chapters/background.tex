...
% Review FSM based masking (outlines, JSON schemas, etc...)
  ...
  LMQL~\cite{beurer2023prompting} utilize Finite State Machines (FSMs) to compute a boolean mask over
  ...
  PICARD~\cite{scholak2021picard}, which parses the top-$k$ beams into
