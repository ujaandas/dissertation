...
target JSON outputs. Samples will be drawn from both Oracle-generated
...
To normalize for task difficulty, OIR will be entropy-scaled using the
model's token distribution:
...
Oracle Intervention Rate and decoding latency will be measured across these
levels in order to quantify how constraint density affects both neural
prediction behavior and verification workload.
